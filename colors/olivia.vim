...
" Colors
let s:black           = { "gui": "#302D2D", "cterm": "0", "cterm16" : "8" }
let s:medium_gray     = { "gui": "#76716F", "cterm": "243", "cterm16" : "243" }
let s:white           = { "gui": "#F0E6E1", "cterm": "15", "cterm16" : "15" }
let s:actual_white    = { "gui": "#FFFFFF", "cterm": "231", "cterm16" : "231" }
let s:light_black     = { "gui": "#423F3E", "cterm": "8", "cterm16" : "0" }
let s:lighter_black   = { "gui": "#54514F", "cterm": "240", "cterm16" : "240" }

" lighter shadows and darker grays
let s:subtle_black  = { "gui": "#302D2D", "cterm": "236", "cterm16" : "236" }
let s:light_gray    = { "gui": "#B2ABA7", "cterm": "249", "cterm16" : "249" }
let s:lighter_gray  = { "gui": "#C6BEBA", "cterm": "251", "cterm16" : "251" }

" flat colors:
let s:asphalt = { "gui": "#312621", "cterm": "233", "cterm16": "NONE"}
let s:asphalt_subtle= { "gui": "#231B18", "cterm": "232", "cterm16": "0"}
let s:dark_asphalt = { "gui": "#9C726A", "cterm": "236", "cterm16": "8"}

let s:red = { "gui": "#E8AD92", "cterm": "204", "cterm16": "1"}
let s:dark_red = { "gui": "#E8906F", "cterm": "203", "cterm16": "9"}

let s:green = { "gui": "#9CE8DA", "cterm": "120", "cterm16": "2"}
let s:dark_green = { "gui": "#3FE8C9", "cterm": "119", "cterm16": "10"}

let s:yellow = { "gui": "#F0D5C7", "cterm": "228", "cterm16": "3"}
let s:dark_yellow = { "gui": "#E8B59E", "cterm": "215", "cterm16": "11"}

let s:blue = { "gui": "#FF8CA7", "cterm": "159", "cterm16": "4"}
let s:dark_blue = { "gui": "#E86D8A", "cterm": "75", "cterm16": "12"}

let s:purple = { "gui": "#A5DEE5", "cterm": "141", "cterm16": "5"}
let s:dark_purple = { "gui": "#6AC1CC", "cterm": "135", "cterm16": "13"}

let s:cyan = { "gui": "#FFC5AA", "cterm": "122", "cterm16": "6"}
let s:dark_cyan = { "gui": "#F29063", "cterm": "121", "cterm16": "14"}

let s:clouds = { "gui": "#FF8CA7", "cterm": "253", "cterm16": "7"}
let s:dark_clouds = { "gui": "#E86D8A", "cterm": "252", "cterm16": "15"}
...
call s:h("Label",        {"fg": s:dark_yellow})
